           ...
           <article>
            ...
            <form id="survey">
                ...
                <div className="question">
                    ...
                    <ButtonGroup name="ipsGatherInfo" />
                </div> 
                ...
                <div className="question">
                    ...
                    <ButtonGroup name="ipsUnderstandDirection" />
                </div>

                    
                <nav className="proceed">
                    <button><Link to="/learning-style-survey">&larr; Previous page</Link></button>
                    <button type="submit"><Link to="/attitude-risk-survey">Next page &rarr;</Link></button>
                </nav>
                </fieldset>
            </form>
           </article>
